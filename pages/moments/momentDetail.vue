...
.send{display:flex;align-items:center;justify-content:center;flex:none;width:36px;height:36px;padding:0;margin:0;border-radius:50%;background:#c49b22;}.send[disabled]{background:#d9c78e;opacity:.75;}.send::after,.like::after{border:0;}
