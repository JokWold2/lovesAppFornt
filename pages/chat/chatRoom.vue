...
<style scoped>
.page { height: 100vh; display: flex; flex-direction: column; overflow: hidden; background: #f6f7f8; }.room-head { display: flex; align-items: center; gap: 14rpx; padding: 18rpx 24rpx; background: #f6f7f8; }.group-avatar { display: flex; align-items: center; justify-content: center; width: 56rpx; height: 56rpx; border-radius: 50%; color: #fff; background: #aab0b8; font-size: 22rpx; }.group-name { flex: 1; overflow: hidden; color: #1d2230; font-size: 30rpx; font-weight: 600; text-overflow: ellipsis; white-space: nowrap; }.add-member { padding: 10rpx 14rpx; border-radius: 14rpx; color: #1768ae; background: #fff; font-size: 24rpx; }.messages { flex: 1; min-height: 0; box-sizing: border-box; padding: 16rpx 24rpx; }.time-divider { margin: 22rpx auto; color: #7d838c; text-align: center; font-size: 23rpx; }.empty { padding-top: 160rpx; color: #8a8f96; text-align: center; font-size: 28rpx; }
</style>
