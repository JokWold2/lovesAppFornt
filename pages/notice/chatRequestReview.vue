...
.page{padding:24rpx;background:#f7f7f7}
.request-card{margin-bottom:20rpx;padding:24rpx;border-radius:18rpx;background:#fff}.people,.people view,.actions{display:flex;align-items:center}.people{gap:24rpx}.people view{gap:10rpx;flex:1}.avatar{width:64rpx;height:64rpx;border-radius:50%;background:#eee}.arrow{color:#999}.message,.time{display:block;margin-top:18rpx}.message{color:#333}.time{font-size:23rpx;color:#999}.actions{justify-content:flex-end;gap:18rpx;margin-top:22rpx}.actions button{margin:0;font-size:25rpx}.approve,.reject-confirm{color:#333;background:var(--bless-primary, #C2A052)}.reject{color:#a33;background:#fff0f0}.empty{padding-top:200rpx;text-align:center;color:#999}.mask{position:fixed;inset:0;display:flex;align-items:flex-end;background:rgba(0,0,0,.45)}.reject-sheet{display:flex;width:100%;min-height:0;flex-direction:column;padding:30rpx;box-sizing:border-box;border-radius:28rpx 28rpx 0 0;background:#fff}.reject-sheet .actions{flex:0 0 auto}.title{flex:0 0 auto;font-size:32rpx;font-weight:700}.reason{display:block;width:100%;min-height:0;margin-top:22rpx;padding:18rpx;box-sizing:border-box;border-radius:12rpx;background:#f5f5f5}
/* #ifdef H5 */
