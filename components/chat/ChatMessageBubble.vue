...
.reply-card { display: flex; align-items: center; gap: 14rpx; margin-bottom: 14rpx; padding: 12rpx 14rpx; border-radius: 12rpx; background: #f0f0f0; min-width: 260rpx; }.reply-copy { min-width: 0; flex: 1; display: flex; flex-direction: column; }.reply-author { color: #656b75; font-size: 22rpx; }.reply-text { overflow: hidden; color: #777; font-size: 24rpx; text-overflow: ellipsis; white-space: nowrap; }.reply-image { width: 72rpx; height: 72rpx; border-radius: 8rpx; flex: none; }
</style>
