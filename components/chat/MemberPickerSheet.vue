...
.member-list{flex:1;height:0;min-height:0;margin:12px 0;background:#fff;border-radius:22px;}.member-row{display:flex;align-items:center;gap:12px;padding:16px;border-bottom:1px solid #f1f0ed;box-sizing:border-box;}.member-row:last-child{border-bottom:0;}.member-avatar{width:44px;height:44px;flex:0 0 44px;border-radius:50%;}.member-avatar--fallback{display:flex;align-items:center;justify-content:center;color:#8b7845;background:#f5edd7;}.member-info{min-width:0;flex:1;display:flex;flex-direction:column;gap:5px;}.member-name{color:#292825;font-size:15px;overflow-wrap:anywhere;}.member-meta{color:#918d85;font-size:12px;}.member-check{display:flex;align-items:center;justify-content:center;flex:0 0 23px;width:23px;height:23px;border:1.5px solid #d8d5ce;border-radius:8px;box-sizing:border-box;}.member-check.selected{background:#f2ce51;border-color:#f2ce51;}.check-tick{width:10px;height:6px;border-bottom:2.5px solid #fff;border-left:2.5px solid #fff;transform:translateY(-1px) rotate(-45deg);}
.empty{padding:35px 16px;text-align:center;color:#918d85;font-size:13px;line-height:1.6;}.retry-button{margin:10px auto;background:#f3f1ec;border-radius:20px;font-size:13px;width:fit-content;}.sheet-actions{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:12px;flex:none;font-size:13px;color:#918d85;}.confirm-button{margin:0;padding:0 20px;min-height:46px;line-height:46px;border-radius:24px;background:#f2ce51;color:#292825;font-size:15px;font-weight:600;}.confirm-button[disabled]{background:#eee6ca;color:#a39a7e;}
/* #ifdef H5 */
